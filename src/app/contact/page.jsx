...
export default function Contact() {
  return (
    <div>
      ...
      <div className="flex justify-center items-center bg-[#e7edf6] py-15">
        <div className="flex justify-center items-center bg-slate-50 rounded-2xl shadow-lg p-2 w-[40%] aspect-[21/9]">
          <iframe
