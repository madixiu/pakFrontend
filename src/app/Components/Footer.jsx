          ...
          <div className="flex flex-col flex-1 gap-10">
            ...
            <div className="">
              <p className="text-justify">
                مجموعه لبنیات و بستنی پاک به عنوان عضوی از گروه صنایع غذایی
                سینا، در راستای ارتقاء سلامت جامعه و افزایش سرانه مصرف فرآورده
                های لبنی با اتکاء به بیش از نیم قرن تجربه، برخورداری از کارکنان
                مجرب، برند معتبر و تکنولوژی روز، فلسفه وجودی خود را تولید و عرضه
                محصولات متنوع و سالم با رعایت استانداردهای بهداشتی، کیفی و زیست
                محیطی دانسته و تلاش می کند تا با فعالیت در بازارهای ملی و فراملی
                رضایت مشتریان را توامان با منافع صاحبان سهام، تامین نماید.
              </p>
            </div>
          </div>
